...
public class RazielClient {
     ...
     * Check session.
     *
     * @throws AuthenticationRequiredException the authentication required exception
     */
     ...
     *
     * @param authenticationClient the new authentication client
     */
     ...
     *
     * @param contentClient the new content client
     */
